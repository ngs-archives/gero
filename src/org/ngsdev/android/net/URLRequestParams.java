...
public class URLRequestParams {
	...
	public String toQueryString() {
		...
		for (String key : this.getKeys()) {
			buf.append(String.format("%s=%s&", key,
					URLEncoder.encode(this.getParameter(key).toString())));
		}
		return buf.toString();
	}
	...
	public boolean isStringParameter(final String name) {
		return isParameterSet(name)
				&& this.getParameter(name) instanceof String;
	}

	public boolean isBooleanParameter(final String name) {
		return isParameterSet(name)
				&& this.getParameter(name) instanceof Boolean;
	}

	public boolean isDoubleParameter(final String name) {
		return isParameterSet(name)
				&& this.getParameter(name) instanceof Double;
	}

	public boolean isIntParameter(final String name) {
		return isParameterSet(name)
				&& this.getParameter(name) instanceof Integer;
	}

	public boolean isByteArrayParameter(final String name) {
		return isParameterSet(name)
				&& this.getParameter(name) instanceof byte[];
	}
