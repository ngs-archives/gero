...
public abstract class URLRequestAdapter
		extends
			ArrayAdapter<URLRequestAdapter.Item>
		implements
	...
	public static interface CreationListener {
		...
		abstract void onCreationProgress(URLRequestAdapter adapter,
				Double progress);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		v = convertView != null && ItemView.class.isInstance(v)
				? convertView
	...
	public boolean load(boolean more) {
		...
		loading = true;
		loadingMore = more;
		if (more && moreButton != null
				&& MoreButton.class.isInstance(moreButton)) {
	...
	public URLRequestAdapter setCreationListener(
